        ...
        <div class="w-full max-w-xs">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input name="email" class="shadow appearance-none {{$errors->has('email') ? 'border-red-500' : ''}} border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Email">
                    @if ($errors->has('email'))
